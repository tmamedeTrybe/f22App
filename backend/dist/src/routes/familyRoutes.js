...
const uploadsFamily_1 = __importDefault(require("../middlewares/uploadsFamily"));
...
familyRoutes.post('/familia/imagem/:id', uploadsFamily_1.default.single('file'), familyController.addImage);
