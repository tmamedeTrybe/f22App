...
Joi.object({
    ...
    segundoBackupBruto: Joi.number().invalid(Joi.ref('primeiroBackupBruto')).error(
    ...
    segundoBackup: Joi.number().invalid(Joi.ref('primeiroBackup')).error(
...
export default validateNewWedding;